...
- Запуск бота командой:         ./ebotFuture-8.0g 
...
- перенесите в эту папку файл бота ebotFuture-8.0g (или скачайте с github командой: wget https://github.com/ebot732/ebotFuture/releases/download/ebotFuture-8.0g/ebotFuture-8.0g)
- откройте screen-сессию (например: screen -S ebotFuture)
- дайте права запуска файлу (команда: chmod 755 ebotFuture-8.0g)
- запустите E-Bot (команда: ./ebotFuture-8.0g)
