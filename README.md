...
- Запуск бота командой:         ./ebotFuture-8.1  
...
- перенесите в эту папку файл бота ebotFuture-8.1 (или скачайте с github командой: wget https://github.com/ebot732/ebotFuture/releases/download/ebotFuture-8.1/ebotFuture-8.1)
- откройте screen-сессию (например: screen -S ebotFuture)
- дайте права запуска файлу (команда: chmod 755 ebotFuture-8.1)
- запустите E-Bot (команда: ./ebotFuture-8.1)
...
Для удобства настройки E-Bot можно использовать прогу tgUpravFuture6. Для этого нужно добавить ее в папку, где работает Е-Bot и запустить (./tgupravFuture6) в отдельном SCREEN. Необходимые данные прога возьмет из БД E-Bot и будет управляться через чат telegram-Bot.
