...
Для удобства настройки E-Bot можно использовать прогу tgUpravFuture8 (https://github.com/ebot732/ebotFuture/releases/download/ebotFuture-8.6/tgUpravFuture8). Для этого нужно добавить ее в папку, где работает Е-Bot и запустить (./tgupravFuture8) в отдельном SCREEN. Необходимые данные прога возьмет из БД E-Bot и будет управляться через чат telegram-Bot.
