...
Для удобства настройки E-Bot можно использовать tgupravFuture3. Для этого нужно добавить его в папку, где работает Е-Bot и запустить в отдельном SCREEN. Данные он возмет из БД E-Bot и будет управляться через чат telegram-Bot.
...
![Screenshot](https://github.com/ebot732/ebotFuture/blob/main/Screenshot_20221107-214119_Telegram.jpg)
