...
- Запуск бота командой:         ./ebotFuture-7.7g 
...
- перенесите в эту папку файл бота ebotFuture-7.7g (или скачайте с github командой: wget https://github.com/ebot732/ebotFuture/releases/download/ebotFuture-7.7g/ebotFuture-7.7g)
- откройте screen-сессию (например: screen -S ebotFuture)
- дайте права запуска файлу (команда: chmod 755 ebotFuture-7.7g)
- запустите E-Bot (команда: ./ebotFuture-7.7g)
