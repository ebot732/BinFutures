...
- перенесите в эту папку файл бота ebotFuture-7g (или скачайте с github командой: wget https://github.com/ebot732/ebotFuture/releases/download/ebotFuture-7.1g/ebotFuture-7.1g)
- откройте screen-сессию (например: screen -S ebotFuture)
- дайте права запуска файла (команда: chmod 755 ebotFuture-7.1g)
- запустите E-Bot (команда: ./ebotFuture-7.1g)
...
Для удобства настройки E-Bot можно использовать tgupravFuture3. Для этого нужно добавить его в папку, где работает Е-Bot и запустить (./tgupravFuture3) в отдельном SCREEN. Данные он возьмет из БД E-Bot и будет управляться через чат telegram-Bot.
