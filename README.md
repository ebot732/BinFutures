...
E-Bot выбирает монету, выросшую за выбранный в настройках период времени на указанный процент (при работе в  LONG, а при работе в SHORT упавшую), 
...
- перенесите в эту папку файл бота ebotFuture-9.2 (или скачайте с github командой: wget https://github.com/ebot732/ebotFuture/releases/download/ebotFuture-9.2/ebotFuture-9.2)
- откройте screen-сессию (например: screen -S ebotFuture)
- дайте права запуска файлу (команда: chmod 755 ebotFuture-9.2)
- запустите E-Bot (команда: ./ebotFuture-9.2)
