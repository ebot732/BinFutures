...
- Запуск бота командой:         ./ebotFuture-8.5  
...
- перенесите в эту папку файл бота ebotFuture-8.5 (или скачайте с github командой: wget https://github.com/ebot732/ebotFuture/releases/download/ebotFuture-8.5/ebotFuture-8.5)
- откройте screen-сессию (например: screen -S ebotFuture)
- дайте права запуска файлу (команда: chmod 755 ebotFuture-8.5)
- запустите E-Bot (команда: ./ebotFuture-8.5)
