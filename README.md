...
- Запуск бота командой:         ./ebotFuture-7.8g 
...
- перенесите в эту папку файл бота ebotFuture-7.8g (или скачайте с github командой: wget https://github.com/ebot732/ebotFuture/releases/download/ebotFuture-7.8g/ebotFuture-7.8g)
- откройте screen-сессию (например: screen -S ebotFuture)
- дайте права запуска файлу (команда: chmod 755 ebotFuture-7.8g)
- запустите E-Bot (команда: ./ebotFuture-7.8g)
...
Для удобства настройки E-Bot можно использовать прогу tgUpravFuture5. Для этого нужно добавить ее в папку, где работает Е-Bot и запустить (./tgupravFuture5) в отдельном SCREEN. Необходимые данные прога возьмет из БД E-Bot и будет управляться через чат telegram-Bot.
